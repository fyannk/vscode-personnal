...
export class HostTreeDataProvider extends Disposable implements vscode.TreeDataProvider<DataTreeItem> {
    ...
    constructor(
        ...
        this._register(vscode.commands.registerCommand('codepersonalremotessh.explorer.add', () => addNewHost()));
        this._register(vscode.commands.registerCommand('codepersonalremotessh.explorer.configure', () => openSSHConfigFile()));
        this._register(vscode.commands.registerCommand('codepersonalremotessh.explorer.refresh', () => this.refresh()));
        this._register(vscode.commands.registerCommand('codepersonalremotessh.explorer.emptyWindowInNewWindow', e => this.openRemoteSSHWindow(e, false)));
        this._register(vscode.commands.registerCommand('codepersonalremotessh.explorer.emptyWindowInCurrentWindow', e => this.openRemoteSSHWindow(e, true)));
        this._register(vscode.commands.registerCommand('codepersonalremotessh.explorer.reopenFolderInNewWindow', e => this.openRemoteSSHLocationWindow(e, false)));
        this._register(vscode.commands.registerCommand('codepersonalremotessh.explorer.reopenFolderInCurrentWindow', e => this.openRemoteSSHLocationWindow(e, true)));
        this._register(vscode.commands.registerCommand('codepersonalremotessh.explorer.deleteFolderHistoryItem', e => this.deleteHostLocation(e)));
    ...
    getTreeItem(element: DataTreeItem): vscode.TreeItem {
        if (element instanceof HostLocationItem) {
            ...
            treeItem.contextValue = 'codepersonalremotessh.explorer.folder';
            return treeItem;
        }
        ...
        treeItem.contextValue = 'codepersonalremotessh.explorer.host';
        return treeItem;
    }
